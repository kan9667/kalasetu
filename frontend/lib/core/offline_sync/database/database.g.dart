...
class $QueueItemsTable extends QueueItems
  ...
  @override
  late final GeneratedColumnWithTypeConverter<QueueItemType, int> type =
      GeneratedColumn<int>('type', aliasedName, false,
              type: DriftSqlType.int, requiredDuringInsert: true)
          .withConverter<QueueItemType>($QueueItemsTable.$convertertype);
  ...
  static const VerificationMeta _productDraftIdMeta =
      const VerificationMeta('productDraftId');
  @override
  late final GeneratedColumn<String> productDraftId = GeneratedColumn<String>(
      'product_draft_id', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  ...
  late final GeneratedColumnWithTypeConverter<QueueStatus, int> status =
      GeneratedColumn<int>('status', aliasedName, false,
              type: DriftSqlType.int,
              requiredDuringInsert: false,
              defaultValue: Constant(QueueStatus.pending.index))
          .withConverter<QueueStatus>($QueueItemsTable.$converterstatus);
  ...
  VerificationContext validateIntegrity(Insertable<QueueItem> instance,
    ...
    if (data.containsKey('product_draft_id')) {
      context.handle(
          _productDraftIdMeta,
          productDraftId.isAcceptableOrUnknown(
              data['product_draft_id']!, _productDraftIdMeta));
    } else if (isInserting) {
  ...
  QueueItem map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return QueueItem(
      ...
      type: $QueueItemsTable.$convertertype.fromSql(attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}type'])!),
      localFilePath: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}local_file_path'])!,
      productDraftId: attachedDatabase.typeMapping.read(
          DriftSqlType.string, data['${effectivePrefix}product_draft_id'])!,
      status: $QueueItemsTable.$converterstatus.fromSql(attachedDatabase
          .typeMapping
  ...
  static JsonTypeConverter2<QueueItemType, int, int> $convertertype =
      const EnumIndexConverter<QueueItemType>(QueueItemType.values);
...
class QueueItem extends DataClass implements Insertable<QueueItem> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    {
      map['status'] =
          Variable<int>($QueueItemsTable.$converterstatus.toSql(status));
    }
  ...
  factory QueueItem.fromJson(Map<String, dynamic> json,
    ...
    return QueueItem(
      ...
      type: $QueueItemsTable.$convertertype
          .fromJson(serializer.fromJson<int>(json['type'])),
      localFilePath: serializer.fromJson<String>(json['localFilePath']),
      productDraftId: serializer.fromJson<String>(json['productDraftId']),
      status: $QueueItemsTable.$converterstatus
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'type':
          serializer.toJson<int>($QueueItemsTable.$convertertype.toJson(type)),
      'localFilePath': serializer.toJson<String>(localFilePath),
      'productDraftId': serializer.toJson<String>(productDraftId),
      'status': serializer
          .toJson<int>($QueueItemsTable.$converterstatus.toJson(status)),
  ...
  QueueItem copyWith(
      ...
      QueueItem(
        ...
        productDraftId: productDraftId ?? this.productDraftId,
  ...
  QueueItem copyWithCompanion(QueueItemsCompanion data) {
    return QueueItem(
      ...
      localFilePath: data.localFilePath.present
          ...
          : this.localFilePath,
      productDraftId: data.productDraftId.present
          ? data.productDraftId.value
          : this.productDraftId,
  ...
  String toString() {
    return (StringBuffer('QueueItem(')
          ...
          ..write('productDraftId: $productDraftId, ')
          ..write('status: $status, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is QueueItem &&
          ...
          other.productDraftId == this.productDraftId &&
...
class QueueItemsCompanion extends UpdateCompanion<QueueItem> {
  ...
  const QueueItemsCompanion({
    ...
    this.productDraftId = const Value.absent(),
  ...
  static Insertable<QueueItem> custom({
    ...
    return RawValuesInsertable({
      ...
      if (productDraftId != null) 'product_draft_id': productDraftId,
  ...
  QueueItemsCompanion copyWith(
      ...
      Value<QueueItemType>? type,
      Value<String>? localFilePath,
      Value<String>? productDraftId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (type.present) {
      map['type'] =
          Variable<int>($QueueItemsTable.$convertertype.toSql(type.value));
    }
    ...
    if (status.present) {
      map['status'] =
          Variable<int>($QueueItemsTable.$converterstatus.toSql(status.value));
    }
...
class $$QueueItemsTableFilterComposer
    extends Composer<_$OfflineSyncDatabase, $QueueItemsTable> {
  ...
  ColumnWithTypeConverterFilters<QueueItemType, QueueItemType, int> get type =>
      $composableBuilder(
          column: $table.type,
...
class $$QueueItemsTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<QueueItemType, int> get type =>
  ...
  GeneratedColumn<String> get productDraftId => $composableBuilder(
      column: $table.productDraftId, builder: (column) => column);
...
class $$QueueItemsTableTableManager extends RootTableManager<
    ...
    (
      QueueItem,
      BaseReferences<_$OfflineSyncDatabase, $QueueItemsTable, QueueItem>
    ),
    QueueItem,
    PrefetchHooks Function()> {
  $$QueueItemsTableTableManager(
      _$OfflineSyncDatabase db, $QueueItemsTable table)
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<QueueItemType> type = const Value.absent(),
            Value<String> localFilePath = const Value.absent(),
            Value<String> productDraftId = const Value.absent(),
